...
function DealColumn({
  ...
  return (
    ...
    >
      <div
        className={cn(
          "rounded-t-xl border-b px-3 py-2.5 flex items-center justify-between gap-2",
          colors.header
        )}
      >
        ...
        {total > 0 && (
          <span className="shrink-0 whitespace-nowrap text-xs font-medium text-zinc-700 dark:text-zinc-300">
