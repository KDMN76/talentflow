...
/**
 * Bouw het rewrite-pad: <pad> → /careers/<slug><pad>. Root ("/") →
 * /careers/<slug>. Zo werken zowel de root als subpaths (/jobs, /privacy) via
 * de bestaande /careers/<slug>-tree — één bron van waarheid voor de render.
 */
